...
$db = [
  ...
  new Food('Catisfactions Snack Gatto con Salmone 180G', 'Lo snack al salmone per gatti e gattini Catisfactions nel formato Maxi Pack è uno spuntino prelibato con una consistenza speciale.', 3.90, 'https://arcaplanet.vtexassets.com/arquivos/ids/288457/catisfaction-snack-gatto-180g-salmone.jpg?v=638254532704570000', new Category('Gatti', '<i class="fa-solid fa-cat"></i>'), 180, ['carni e derivati', 'cereali', 'oli e grassi']),
  ...
  new Toy('Tiragraffi Ottawa', 'Il Tiragraffi Ottawa è un elemento fondamentale per il gatto', 12.99, 'https://arcaplanet.vtexassets.com/arquivos/ids/280253/tiragraffi-ottawa-lovedi.jpg?v=638114627579570000', new Category('Gatti', '<i class="fa-solid fa-cats"></i>'), 'Interattivo', '50X31cm'),
  ...
  new Accessory('Ciotola Pieghevole in Silicone Blu', 'Ciotola da viaggio per cani con bordo in plastica rinforzato per una migliore stabilità.' , 7.52 , 'https://arcaplanet.vtexassets.com/arquivos/ids/276489/pet-around-you-ciotola-pieghevole-blu.jpg?v=638034173855230000', new Category('Cani', '<i class="fa-solid fa-dog"></i>'), '750ml')
